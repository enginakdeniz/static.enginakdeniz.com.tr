        ...
        i.prototype.close = function (e) {
            ...
            e && e.preventDefault(),
                ...
                e.isDefaultPrevented() || (s.removeClass("in"),
                    t.support.transition && s.hasClass("sppb-fade") ? s.one("bsTransitionEnd", a).emulateTransitionEnd(150) : a())
        }
        ;
    var n = t.fn.spbalert;
    ...
    function (t) {
        ...
        function i(i) {
            return this.each((function () {
                ...
                s || n.data("sppb.carousel", s = new e(this, a)),
                    "number" == typeof i ? s.to(i) : o ? s[o]() : a.interval && s.pause().cycle()
            }
            ))
        }
        e.VERSION = "3.2.0",
            ...
            e.prototype.getItemIndex = function (t) {
                return this.$items = t.parent().children(".sppb-item"),
            ...
            e.prototype.to = function (e) {
                ...
                if (!(e > this.$items.length - 1 || e < 0))
                    return this.sliding ? this.$element.one("slid.sppb.carousel", (function () {
                        i.to(e)
                    }
            ...
            e.prototype.slide = function (e, i) {
                ...
                if (this.$element.trigger(d),
                    ...
                    return t.support.transition && this.$element.hasClass("sppb-slide") ? (s.addClass(e),
                        s[0].offsetWidth,
                        n.addClass(o),
                        s.addClass(o),
        ...
        t.fn.sppbcarousel = i,
            ...
            t(document).ready((function () {
                t(".sppb-carousel").each((function (e) {
                    ...
                    for (var a = 0; a < i.length; a++)
                        s += 0 == a ? '<li data-sppb-target="#' + n + '" class="active" data-sppb-slide-to="0"></li>' : '\n<li data-sppb-target="#' + n + '" data-sppb-slide-to="' + a + '"></li>';
                    t(this).find(">.sppb-carousel-indicators").html(s),
                        t(this).find(".sppb-carousel-control").attr("href", "#" + n),
            ...
            t(document).on("click.sppb.carousel.data-api", "[data-slide], [data-sppb-slide-to]", (function (e) {
                var n, s = t(this), a = t(s.attr("data-sppb-target") || (n = s.attr("href")) && n.replace(/.*(?=#[^\s]+$)/, ""));
    ...
    function (t) {
        ...
        t(document).on("click", ".sppb-panel-heading", (function (e) {
            ...
            t(this).hasClass("active") ? (t(this).removeClass("active"),
                i.next().slideUp()) : (s.removeClass("active"),
                    a.slideUp(),
                    setTimeout(() => {
            ...
            e.prototype.activate = function (e, i, n) {
                ...
                function o() {
                    s.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"),
                        e.addClass("active"),
                        a ? (e[0].offsetWidth,
                            e.addClass("in")) : e.removeClass("sppb-fade"),
                ...
                t(".sppb-tab").each((function (e) {
                    ...
                    t(this).find(">.sppb-nav").children().each((function (e) {
                        t(this).find(">a").attr("href", "#" + i + "-" + (e + 1)),
                            t(this).find(">a").attr("id", "#" + n + "-" + (e + 1)),
                            t(this).find(">a").attr("aria-controls", "#" + i + "-" + (e + 1))
                    }
                    )),
    ...
    function (t) {
        ...
        e.VERSION = "3.2.0",
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    l && (o = o.replace(r, "") || "top"),
                        s.detach().css({
                            ...
                            left: 0,
                            display: "block"
                        }).addClass(o).data("sppb." + this.type, this),
                    ...
                    if (l) {
                        ...
                        o = "bottom" == o && p.top + p.height + h - f.scroll > f.height ? "top" : "top" == o && p.top - f.scroll - h < 0 ? "bottom" : "right" == o && p.right + d > f.width ? "left" : "left" == o && p.left - d < f.left ? "right" : o,
                            s.removeClass(c).addClass(o)
                    }
                    var m = this.getCalculatedOffset(o, p, d, h);
                    this.applyPlacement(m, o);
                    var v = function () {
                        n.$element.trigger("shown.sppb." + n.type),
                            n.hoverState = null
                    };
            ...
            e.prototype.hide = function () {
                ...
                if (this.$element.removeAttr("aria-describedby"),
                    ...
                    return i.removeClass("in"),
                        t.support.transition && this.$tip.hasClass("sppb-fade") ? i.one("bsTransitionEnd", s).emulateTransitionEnd(150) : s(),
            ...
            e.prototype.toggle = function (e) {
                var i = this;
                e && ((i = t(e.currentTarget).data("sppb." + this.type)) || (i = new this.constructor(e.currentTarget, this.getDelegateOptions()),
                    t(e.currentTarget).data("sppb." + this.type, i))),
        ...
        t.fn.sppbtooltip = function (i) {
            return this.each((function () {
                var n = t(this)
                    ...
                    , a = "object" == typeof i && i;
                (s || "destroy" != i) && (s || n.data("sppb.tooltip", s = new e(this, a)),
                    "string" == typeof i && s[i]())
            }
            ))
        }
        ...
        t.fn.sppbpopover = function (i) {
            return this.each((function () {
                var n = t(this)
                    ...
                    , a = "object" == typeof i && i;
                (s || "destroy" != i) && (s || n.data("sppb.popover", s = new e(this, a)),
                    "string" == typeof i && s[i]())
            }
            ))
        }
...
* Copyright (c) 2014 Matthieu Aussaguel; Licensed MIT */
                ...
                return a.prototype.defaults = {
                    ...
                    a.prototype.start = function () {
                        ...
                        if (this.stopped = !1,
                            this.boxes = function () {
                                ...
                                for (s = [],
                                    t = 0,
                                    i = (n = this.element.querySelectorAll("." + this.config.boxClass)).length; i > t; t++)
                                    e = n[t],
                                        s.push(e);
                                return s
                            }
                                ...
                                for (o = [],
                                    ...
                                    n = e[s],
                                        o.push(function () {
                                            ...
                                            for (a = [],
                                                t = 0,
                                                e = (s = n.addedNodes || []).length; e > t; t++)
                                                i = s[t],
                                                    a.push(this.doSync(i));
                                            return a
                                        }
                                            .call(t));
                                return o
                    ...
                    a.prototype.doSync = function (t) {
                        ...
                        if (!this.stopped) {
                            ...
                            for (o = [],
                                i = 0,
                                n = (a = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; n > i; i++)
                                e = a[i],
                    ...
                    a.prototype.applyStyle = function (t, e) {
                        var i, n, s;
                        return n = t.getAttribute("data-sppb-wow-duration"),
                    ...
                    a.prototype.vendorCSS = function (t, e) {
                        var i, n, s, a, o, r;
                        for (i = (n = window.getComputedStyle(t)).getPropertyCSSValue(e),
                            a = 0,
                            o = (r = this.vendors).length; o > a; a++)
                            s = r[a],
                    ...
                    a.prototype.isVisible = function (t) {
                        var e, i, n, s, a;
                        return i = t.getAttribute("data-sppb-wow-offset") || this.config.offset,
    ...
    function (t) {
                ...
                for (e = e || ((d = {
                    ...
                    if (t.contains(r, h[c])) {
                        var u, f, m, v = t(h[c]), g = {
                            height: v.height(),
                            width: v.width()
                        }, b = v.offset(), y = v.data("inview");
                        if (!i || !e)
                            return;
                        b.top + g.height > i.top && b.top < i.top + e.height && b.left + g.width > i.left && b.left < i.left + e.width ? (m = (u = i.left > b.left ? "right" : i.left + e.width < b.left + g.width ? "left" : "both") + "-" + (f = i.top > b.top ? "bottom" : i.top + e.height < b.top + g.height ? "top" : "both"),
                            y && y === m || v.data("inview", m).trigger("inview", [!0, u, f])) : y && v.data("inview", !1).trigger("inview", [!1])
                    }
        }
        t.event.special.inview = {
            ...
            remove: function (e) {
                ...
                t.isEmptyObject(s) && (clearInterval(n),
                    n = null)
            }
        },
            ...
            t(document).on("inview", ".sppb-progress", (function (e, i, n, s) {
                ...
                i && (a.css("width", a.data("width")),
                    t(this).unbind("inview"))
            }
            )),
                        ...
                        t({
                            ...
                            step: function () {
                                a.text(Math.floor(this.value)),
                                    i && a.text(a.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"))
                            },
                            complete: function () {
                                parseInt(a.text()) !== e && (a.text(e),
                                    i && a.text(a.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")))
                            }
                        })
                }
            ...
            t(document).on("inview", ".sppb-animated-number", (function (e, i, n, s) {
                var a = t(this);
                i && (a.sppbanimateNumbers(a.data("digit"), !1, a.data("duration")),
                    a.unbind("inview"))
            }
            )),
    ...
    jQuery((function (t) {
                ...
                if (n)
                    t(this).on("change keyup", (function () {
                        var e = t(this).val().replace(/\s/g, "")
                            ...
                            , a = t(this).attr("name");
                        "" === e || 0 === e.length ? (s = !0,
                            t(this).addClass("sppb-has-field-error")) : (s = !1,
                                t(this).removeClass("sppb-has-field-error")),
                            "text" !== n || "captcha_question" === a || "phone" === a || isNaN(e) || s ? (s = !1,
                                t(this).removeClass("sppb-has-field-error")) : (s = !0,
                                    t(this).addClass("sppb-has-field-error")),
                            void 0 !== t(this).prop("required") && e.length > 0 && "email" === n && !s && (i(e) ? (t(this).removeClass("sppb-has-field-error"),
                                s = !1) : (t(this).addClass("sppb-has-field-error"),
                                    s = !0))
                    }
                    ));
                else {
                    ...
                    "" !== o && 0 !== o.length || (s = !0,
                        t(this).addClass("sppb-has-field-error")),
                        "text" !== r || isNaN(o) || "captcha_question" === l || "phone" === l || s || (s = !0,
                            t(this).addClass("sppb-has-field-error")),
                        void 0 !== t(this).prop("required") && o.length > 0 && "email" === t(this).attr("type") && !s && (i(o) || (t(this).addClass("sppb-has-field-error"),
                            s = !0))
                }
            }
            )),
        ...
        function n(e) {
            ...
            if (void 0 !== e.prop("required")) {
                ...
                e.attr("type"),
                    e.attr("name");
                if (void 0 === s || "undefined" === s.find("span.sppb-form-builder-required"))
                    return !1;
                if (0 === a.length && e.prop("required") && (s.find("span.sppb-form-builder-required").show(),
                    n = !0),
                    a.length > 0 && e.prop("required") && (s.find("span.sppb-form-builder-required").hide(),
                        n = !1),
                    "radio" === e.attr("type") && e.prop("required")) {
                    var o = e.attr("name");
                    t('input[name="' + o + '"]').is(":checked") ? (s.find("span.sppb-form-builder-required").hide(),
                        n = !1) : (s.find("span.sppb-form-builder-required").show(),
                            n = !0)
                }
                if ("checkbox" === e.attr("type")) {
                    ...
                    s.find("input[type=checkbox]").each((function (e, i) {
                        ...
                        r ? (s.find("span.sppb-form-builder-required").show(),
                            n = !0) : (s.find("span.sppb-form-builder-required").hide(),
                                n = !1)
                }
            }
            return void 0 !== e.prop("required") && a.length > 0 && "email" === e.attr("type") && (i(a) ? (s.find("span.sppb-form-builder-required").hide(),
                n = !1) : (s.find("span.sppb-form-builder-required").show(),
                    n = !0)),
                n
        }
        ...
        e(t(".sppb-ajaxt-contact-form"), !0),
            t(document).on("submit", ".sppb-ajaxt-contact-form", (function (i) {
                ...
                if (e(n))
                    return n.find(".sppb-form-validation-error").remove(),
                        n.append('<p class="sppb-form-validation-error"> Please re-check required fields! </p>'),
                        !1;
                ...
                if (n.closest(".sp-page-builder").hasClass("mod-sppagebuilder")) {
                    ...
                    n.closest(".sp-page-builder").hasClass("sppb-article-page-wrapper") && (a.value = "article");
                s.push(a);
                var r = {
            ...
            t(".sppb-addon-form-builder-form").length > 0 && (s(t(".sppb-addon-form-builder-form"), !0),
            ...
            t(document).on("submit", ".sppb-addon-form-builder-form", (function (e) {
                ...
                if (a)
                    return i.next(".sppb-ajax-contact-status").html('<span class="sppb-text-danger">Please check the required field!</span>').fadeIn().delay(4e3).fadeOut(500),
                        !1;
                ...
                if (i.closest(".sp-page-builder").hasClass("mod-sppagebuilder")) {
                    ...
                    i.closest(".sp-page-builder").hasClass("sppb-article-page-wrapper") && (l.value = "article");
                n.push(l);
                var d = {
                    option: "com_sppagebuilder",
                    task: "ajax",
                ...
                return t.ajax({
                    ...
                    success: function (e) {
                        ...
                        "json" == p ? a.status && (i.trigger("reset"),
                            void 0 === a.gcaptchaType || !a.gcaptchaType.length || "invisible" != a.gcaptchaType && "dynamic" != a.gcaptchaType || (a.gcaptchaId ? (gcaptchaWidgetId = t("#" + a.gcaptchaId).attr("data-recaptcha-widget-id")) && (grecaptcha.reset(gcaptchaWidgetId),
                                "invisible" == a.gcaptchaType && grecaptcha.execute(gcaptchaWidgetId)) : (grecaptcha.reset(),
                                    "invisible" == a.gcaptchaType && grecaptcha.execute()))) : i.trigger("reset"),
                            i.find(".fa-spin").removeClass("fa-spinner fa-spin"),
                            i.next(".sppb-ajax-contact-status").html(l).fadeIn().delay(4e3).fadeOut(500),
                            "yes" === o && setTimeout((function () {
    ...
    jQuery((function (t) {
        t(document).on("submit", ".sppb-optin-form", (function (e) {
            ...
            if (i.closest(".sp-page-builder").hasClass("mod-sppagebuilder")) {
                ...
                i.closest(".sp-page-builder").hasClass("sppb-article-page-wrapper") && (s.value = "article");
            n.push(s);
            var o = {
                option: "com_sppagebuilder",
                task: "ajax",
            ...
            return t.ajax({
                ...
                success: function (e) {
                    var n = t.parseJSON(e);
                    if (!n.success)
                        return i.find(".fa-spin").removeClass("fa-spinner fa-spin"),
                            n.message ? i.next(".sppb-optin-form-status").html('<p class="sppb-alert sppb-alert-warning">' + n.message + "</p>").fadeIn().delay(4e3).fadeOut(1e3) : n.messages && i.next(".sppb-optin-form-status").html('<p class="sppb-alert sppb-alert-warning">' + n.messages + "</p>").fadeIn().delay(4e3).fadeOut(1e3),
                            !1;
                    ...
                    i.find(".fa-spin").removeClass("fa-spinner fa-spin"),
                        i.next(".sppb-optin-form-status").html('<p class="' + a + '">' + s.content + "</p>").fadeIn().delay(4e3).fadeOut(1e3)
                }
            }),
                !1
        }
        ...
        e.prototype.init = function () {
            ...
            e.prototype.singleLetters = function (e) {
                e.each((function () {
                    ...
                    for (i in n)
                        e.parents(".animation-wave").length > 0 && (n[i] = "<em>" + n[i] + "</em>"),
            ...
            e.prototype.hideWord = function (t) {
                ...
                if (t.parents(".animated-heading-text").hasClass("type")) {
                    ...
                    t.parents(".animated-heading-text").hasClass("text-clip") ? t.parents(".animated-text-words-wrapper").animate({
                        width: "2px"
                    }, i.revealDuration, (function () {
                        i.switchWord(t, e),
                            i.showWord(e)
                    }
                    )) : t.parents(".animated-heading-text").hasClass("loading-bar") ? (t.parents(".animated-text-words-wrapper").removeClass("is-loading"),
                        this.switchWord(t, e),
                        setTimeout((function () {
                            i.hideWord(e)
                        }
                        ...
                        this.setParentClassWidth(e)) : (this.switchWord(t, e),
                            setTimeout((function () {
                                i.hideWord(e)
                            }
                            ), i.animationDelay),
            ...
            e.prototype.showWord = function (t, e) {
                var i = this;
                t.parents(".animated-heading-text").hasClass("type") ? (i.showLetter(t.find("i").eq(0), t, !1, e),
                    t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".animated-heading-text").hasClass("text-clip") && t.parents(".animated-text-words-wrapper").animate({
                        width: t.width() + 10
                    }, i.revealDuration, (function () {
                        setTimeout((function () {
                            i.hideWord(t)
    ...
    function (t) {
        function e() {
            if ("undefined" == typeof stickyParent && (stickyParent = t('[data-sticky-it="true"]').parents(".sppb-section ")),
                ...
                stickyParentWrap = stickyParent.parents(".sppb-sticky-wrap"),
                    ...
                    window.scrollY >= e.top && !stickyParent.hasClass("sppb-sticky-it") ? (stickyParent.wrap('<div class="sppb-sticky-wrap" style="height:' + stickyParent.outerHeight() + 'px;"></div>'),
                        stickyParent.addClass("sppb-sticky-it")) : window.scrollY < e.top && stickyParent.hasClass("sppb-sticky-it") && (stickyParent.removeClass("sppb-sticky-it"),
                            stickyParent.unwrap())
            }
        }
        window.sppbVideoBackgroundResize = function (t) {
            ...
            iframeW = e,
                ...
                e / i < 16 / 9 && (iframeW = i * (16 / 9),
                    iframeH = i,
                    marginLeft = -Math.round((iframeW - e) / 2),
                    marginTop = -Math.round((iframeH - i) / 2)),
                t.find(".sppb-youtube-video-bg iframe").css({
                    maxWidth: "1000%",
    ...
    */
    function (t) {
        t.fn.basictable = function (e) {
            var i = function (e, i) {
                var s = [];
                if (i.tableWrap && e.wrap('<div class="bt-wrapper"></div>'),
                    i.header) {
                    var a = "";
                    ...
                    e.children().each((function () {
                        ...
                        if ("" !== e.html() && "&nbsp;" !== e.html() || n.showEmptyCells) {
                            ...
                            e.attr("data-th", a.trim()),
                                n.contentWrap && !e.children().hasClass("bt-content") && e.wrapInner('<span class="bt-content" />')
                        } else
                            e.addClass("bt-hide")
                    }
                    ))
            ...
            this.each((function () {
                ...
                if (0 === n.length || n.data("basictable")) {
                    if (n.data("basictable")) {
                        ...
                        "destroy" === e ? r(n, l) : "restart" === e ? (r(n, l),
                            n.data("basictable", l),
                            i(n, l),
                            s(n, l)) : "start" === e ? a(n, l) : "stop" === e ? o(n, l) : s(n, l)
                    }
                    return !1
                }
                ...
                null === d.breakpoint && null === d.containerBreakpoint && (d.breakpoint = 568),
                    ...
                    d.noResize || (s(n, n.data("basictable")),
            ...
            t.fn.addSortWidget = function (e) {
                ...
                return t("th", i).each((function (s) {
                    t("<div>").addClass("sppb-table-addon-sortable").attr("data-content", e.no_sort).on("click", (function () {
                        t(".sppb-table-addon-sortable", i).attr("data-content", e.no_sort),
                        ...
                        for (var o = i.has("tbody") ? "tbody" : "", r = 0; r < a.length; r++)
                            t(o, i).append(a[r])
                    }
                    )).appendTo(this)
                }
            ...
            t.fn.pageMe = function (e) {
                ...
                void 0 !== i.childSelector && (o = n.find(i.childSelector)),
                    void 0 !== i.pagerSelector && this.next().length && (r = this.next().find(i.pagerSelector));
                var l = o.size()
                    , p = Math.ceil(l / s);
                this.next().length && this.next().find(".sppb-table-total-reg").html("Total Entries: " + l),
                    r.data("curr", 0),
                ...
                for (var d = 0; p > d && 0 == i.hidePageNumbers;)
                    t('<li class="sppb-page-item"><a href="#" class="sppb-table-paginate-link sppb-page-link">' + (d + 1) + "</a></li>").appendTo(r),
                        d++;
                function h(t) {
                    var e = t * s
                        , i = e + s;
                    o.css("display", "none").slice(e, i).show(),
                        ...
                        r.children().eq(t + 1).addClass("active")
                }
                i.showPrevNext && t('<li class="sppb-page-item"><a href="#" class="sppb-table-next-link sppb-page-link"  title="' + i.nextText + '"><i aria-hidden="true" class="fa fa-angle-right"></i></a></li>').appendTo(r),
                    ...
                    r.find("li .sppb-table-next-link").click((function () {
                        return goToPage = parseInt(r.data("curr")) + 1,
                            h(goToPage),
                            a && n.find("tr:first-child").show(),
                            a && n.find("tr:first-child").show(),
                            !1
    ...
    window.addEventListener("DOMContentLoaded", (function () {
        ...
        function i(t, i) {
            t.forEach((function (t) {
                ...
                t.intersectionRatio && ("IMG" !== n.tagName && "IFRAME" !== n.tagName || (n.src = n.dataset.large),
        ...
        if (t.length > 0) {
            !function () {
                if ("IntersectionObserver" in window) {
                    ...
                    t.forEach((function (t) {
                        t.src = t.dataset.src,
                            t.classList.contains("sppb-element-lazy") && t.classList.add("sppb-element-loaded")
                    }
                    ))
            }()
        }
...
!function (t) {
    ...
    e.prototype.bindCustomAnimation = function () {
        ...
        e.prototype.getCustomAnimationActionByName = function (t) {
            ...
            return n.map((function (t, a) {
                e < parseInt(t.keyframe) && null === i.to && (void 0 !== i.fixed && delete i.fixed,
                    t.toKF = 0,
                    i.to = t,
                    void 0 !== n[a - 1] && (n[a - 1].scroll = 0,
                        i.from = n[a - 1]),
                    s = !0),
                    a === n.length - 1 && !1 === s && (i.fixed = !0,
                        i.to = t,
                        void 0 !== n[a - 1] && (n[a - 1].scroll = 0,
                            i.from = n[a - 1]))
            }
        ...
        e.prototype.getMoveTransform = function (t, e, i) {
            var n = e.to.keyframe
                ...
                , d = e.from.z
                , h = e.to.z;
            return e.goal.x = this.getTAxis(o, r, i, a),
        ...
        e.prototype.getOpacity = function (t, e, i) {
            var n = e.to.keyframe
                ...
                , o = e.from.value
                , r = e.to.value;
            return e.goal.value = this.getTAxis(o, r, i, a),
                e
        }
        ;
    var i = function () {
        ...
        return _createClass(t, [{
            ...
            key: "wrapWithParent",
            value: function () {
                if (null !== this.element.parentElement && "sppb-addon-wrapper" === this.element.parentElement.className && (this.element = this.element.parentElement),
            ...
            value: function () {
                this.event = {
                    ...
                    this.element && "sppb-addon-wrapper" !== this.element.className || (this.element && this.element.style && (this.element.style.transform = "perspective(" + this.settings.perspective + "px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)"),
                        this.resetGlare())
            }
        }, {
            key: "resetGlare",
    ...
    function r(e) {
        void 0 !== addonInteraction.mouse_movement && addonInteraction.mouse_movement.map((function (n) {
            ...
            if (s.parent().hasClass("sppb-addon-wrapper") || s.wrap('<div class="sppb-addon-wrapper"></div>'),
                e < 768 && !1 === n.enable_mobile)
                return void 0 !== o[n.addonId] && (o[n.addonId].tiltIntance.destroy(),
                    delete o[n.addonId]),
                    !1;
    ...
    function p(t, i) {
        var n = {
            ...
            , a = t.origin
            , o = new e(s);
        return o.bindCustomAnimation(),
            o.actionProperty.map((function (t) {
                var e = o.getCustomAnimationActionByName(t, i);
                null !== e.from && (Object.assign(n[t].from, e.from.property),
                    n[t].from.f = !0,
                    ...
                    null !== e.to && (Object.assign(n[t].to, e.to.property),
                        void 0 !== n[t].to.x && (n[t].to.x = "" === n[t].to.x ? 0 : parseFloat(n[t].to.x),
                            n[t].goal.x = n[t].to.x),
                        void 0 !== n[t].to.y && (n[t].to.y = "" === n[t].to.y ? 0 : parseFloat(n[t].to.y),
                            n[t].goal.y = n[t].to.y),
                        void 0 !== n[t].to.z && (n[t].to.z = "" === n[t].to.z ? 0 : parseFloat(n[t].to.z),
                            n[t].goal.z = n[t].to.z),
                        void 0 !== n[t].to.value && (n[t].to.value = "" === n[t].to.value ? 0 : parseFloat(n[t].to.value),
    ...
    window.addEventListener("DOMContentLoaded", (function (e) {
        "undefined" != typeof addonInteraction && (r(s),
            function () {
                ...
                t(document).ready((function () {
                    e.map((function (e) {
                        ...
                        i.parent().hasClass("sppb-addon-wrapper") || i.wrap('<div class="sppb-addon-wrapper"></div>'),
                            n[e.addonId] = i,
